...
public:
    delayVerify ( double expectedDelay, epicsThreadedTimerQueue & );
    expireStatus expire ();
...
delayVerify::delayVerify ( double expectedDelayIn, epicsThreadedTimerQueue &queue ) :
...
void testAccuracy ()
{
    ...
    epicsThreadedTimerQueue &queue = epicsThreadedTimerQueue::allocate ( true, epicsThreadPriorityMax );
...
public:
    cancelVerify ( epicsThreadedTimerQueue & );
    expireStatus expire ();
    void * operator new ( size_t size );
    void operator delete ( void *pCadaver, size_t size );
    void start ( const epicsTime &expireTime );
...
cancelVerify::cancelVerify ( epicsThreadedTimerQueue &queue ) :
...
void testCancel ()
{
    ...
    epicsThreadedTimerQueue &queue = epicsThreadedTimerQueue::allocate ( true, epicsThreadPriorityMin );
...
public:
    periodicVerify ( epicsThreadedTimerQueue & );
    expireStatus expire ();
    void * operator new ( size_t size );
    void operator delete ( void *pCadaver, size_t size );
    void start ( const epicsTime &expireTime );
...
periodicVerify::periodicVerify ( epicsThreadedTimerQueue &queue ) :
