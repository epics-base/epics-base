...
value given to it and can be modified via dbPuts. See 
...
D, E, F, G, H, I, J, K, or L) specified by the SELN field. The SELN field contains a
...
can be either NO_ALARM, MINOR, or MAJOR. See 
L<Alarm Specification|https://wiki-ext.aps.anl.gov/epics/index.php/RRM_3-14_Concepts#Alarm_Specification> 
...
L<Monitor Specification|https://wiki-ext.aps.anl.gov/epics/index.php/RRM_3-14_Concepts#Monitor_Specification> 
