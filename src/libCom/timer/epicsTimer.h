...
class epicsShareClass epicsTimerQueue {         /* X aCC 655 */
public:
...
class epicsShareClass epicsTimerQueueNotify {   /* X aCC 655 */
public:
...
class epicsShareClass epicsTimerQueuePassive /* X aCC 655 */
    : public epicsTimerQueue {
public:
