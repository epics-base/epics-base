...
static const iocshFuncDef epicsShowModuleVersionFuncDef = {"epicsShowModuleVersion", 0, NULL,
                                                        "Shows all the modules loaded on the ioc"};
static void epicsShowModuleVersionCallFunc(const iocshArgBuf *args)
{
...
void epicsStdCall libComRegister(void)
{
    ...
    iocshRegister(&epicsShowModuleVersionFuncDef, epicsShowModuleVersionCallFunc);
