...
MAIN(cvtFastTest)
{
    ...
    tryFString(Float, 0.000000004999999F, 8, 10);
    tryFString(Float, 0.000000005000001F, 8, 10);
    tryFString(Float, 0.00000004999999F, 7, 9);
    tryFString(Float, 0.00000005000001F, 7, 9);
    tryFString(Float, 0.0000004999999F, 6, 8);
    tryFString(Float, 0.0000005000001F, 6, 8);
    tryFString(Float, 0.000004999999F, 5, 7);
    tryFString(Float, 0.000005000001F, 5, 7);
    tryFString(Float, 0.00004999999F, 4, 6);
    tryFString(Float, 0.00005000001F, 4, 6);
    tryFString(Float, 0.0004999999F, 3, 5);
    tryFString(Float, 0.0005000001F, 3, 5);
    tryFString(Float, 0.004999999F, 2, 4);
    tryFString(Float, 0.005000001F, 2, 4);
    tryFString(Float, 0.04999999F, 1, 3);
    tryFString(Float, 0.05000001F, 1, 3);
    tryFString(Float, 0.4999999F, 0, 1);
    tryFString(Float, 0.5000001F, 0, 1);
